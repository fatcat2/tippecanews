...
def test_send_slack_press_release():
    ...
    assert "accessory" in json.loads(responses.calls[0].request.body)["blocks"][0].keys()

@responses.activate
def test_send_non_press_release():
    test_title = "This is a test message."
    test_link = "http://ryanjchen.com"
    test_url = "https://slack.com/api/chat.postMessage"
    ...
    send_slack(test_title, test_link, "12-05-1889", is_pr=False)
